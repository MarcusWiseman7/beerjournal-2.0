    ...
    <div class="add-beer">
        ...
        <div class="add-beer__inputs">
            <b-input label="Name" labelFor="beer">
                <input type="text" autofocus id="beer" v-model="beer" maxlength="75" placeholder="The beer's name..." />
            </b-input>
            <b-input class="add-beer__inputs--last" label="Brewery" labelFor="brewery">
                <input type="text" id="brewery" v-model="brewery" maxlength="75" placeholder="The brewery's name..." />
            </b-input>
        </div>
...
export default {
    ...
    methods: {
        add() {
            this.$store.dispatch('addNewBeer', { beer: this.beer, brewery: this.brewery }).then(() => {
                this.beer = '';
                this.brewery = '';
            });
        },
